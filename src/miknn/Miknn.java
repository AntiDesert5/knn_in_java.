...
public class Miknn {
	...
	/**
	 * Devuelve el valor mayoritario en un conjunto de cadenas
	 * el valor mayoritario es el valor más frecuente (el modo)
	 * maneja valores de mayoría múltiple (lazos rotos al azar)
	 *
	 * @param array un conjunto de cuerdas
	 * Devuelve la cadena más frecuente del conjunto *
	 */ 
	private static String escojermejorclase(String[] array) //lo que dice la funcion xd
	{
		//add the String array to a HashSet to get unique String values
		Set<String> h = new HashSet<String>(Arrays.asList(array)); //Añade la matriz de cuerdas a un HashSet para obtener valores únicos de las cuerdas.
    ...
    public static void main(String[] args) {
        ...
        int k = 5;// # of neighbours  //cambiar por lo que esta en la interfaz
		//list to save city data
		List<City> cityList = new ArrayList<City>();
		//list to save distance result //Resultados de distancia
		...
		String majClass = escojermejorclase(ss);
